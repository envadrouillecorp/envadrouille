...
var known_sentences = {
   /** Header **/
   'update_gal':'Your gallery is outdated. <a href="index.php?action=update&nversion={0}&oversion={1}">Update</a> automatically or <a href="http://update.envadrouille.org/latest.zip">download</a> the last version.',
